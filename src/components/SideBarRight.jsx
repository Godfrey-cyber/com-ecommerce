...
const SideBarRight = () => {
	...
	const user = useSelector(selectUser).username?.split(" ")[0]
	return (
		<div className="lg:col-span-10 col-span-12 flex flex-col bg-white min-h-screen px-4 md:px-8 lg:px-12 py-10 flex bg-zinc-200 flex-col space-y-3 ">
			<p className="text-sm text-gray-700 font-normal">Hello {user}, hope you are doing well</p>
			<div className="grid grid-cols-12 gap-y-4 p-2 w-full">
				<span className="col-span-12 lg:col-span-6 flex flex-col space-y-4 px-8 lg:px-20 py-8 rounded-md shadow shadow-gray-200 bg-white mx-auto">
