...
const DashHeader = () => {
	return (
		<header className="flex justify-between items-center px-20 py-1 h-[60px] w-full shadow-sm shadow-gray-300 bg-gradient-to-r from-slate-50 to-blue-500 top-0 left-0 right-0 sticky">
