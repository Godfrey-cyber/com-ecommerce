						...
						<div key={id} className="cart_div">
                            ...
                            <span className="flex items-center justify-between w-full">
                                <span className="flex items-center">
                                    <button onClick={() => count >= 1 && setCount(count - 1)} onClick={() => dispatch(decrement({id: item._id, count }))} className="items-center flex text-lg text-gray-500 py-1 lg:py-2 px-1.5 lg:px-3 hover:text-white transition delay-300 transition delay-300 cursor-pointer rounded-tl-md rounded-bl-md hover:bg-red-200 bg-gray-200">-</button>
